	...
	<main class="flex-shrink-0">
		<div class="container">
			...
			<div class='card'>
				...
				<%
				Computer computerInPagina = (Computer) request.getAttribute("computerDaInviareAPaginaRimuovi");
				%>
				...
				<div class='card-body'>
					...
					<dl class="row">
						...
						<dd class="col-sm-9"><%=computerInPagina.getDataRilascio() != null
		? new SimpleDateFormat("dd/MM/yyyy").format(computerInPagina.getDataRilascio())
		: "N.D."%></dd>
					</dl>
				...
				<div class='card-footer'>
					...
					<form action="ExecuteRimuoviComputerServlet?idComputer=<%=computerInPagina.getId()%>"
						method="post">
