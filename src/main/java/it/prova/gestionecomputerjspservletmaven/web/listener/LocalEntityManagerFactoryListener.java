package it.prova.gestionecomputerjspservletmaven.web.listener;
...
public class LocalEntityManagerFactoryListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		try {
			entityManagerFactory = Persistence.createEntityManagerFactory("gestionecomputerjspservletmaven_unit");
		} catch (Throwable ex) {
